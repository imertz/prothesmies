...
export const getProtaseisDetails = (
  ...
  if (new Date(start).getTime() >= new Date('2026-01-01').getTime()) {
    if (options.klisi === false) {
      text.nomothesia = [
        `Αρθ. 237 § 1 ΚΠολΔ (Ν. 5221/2025). Μέσα σε ενενήντα (90) ημέρες από τη λήξη της προθεσμίας για την επίδοση της αγωγής κατά την παρ. 2 του άρθρου 215, οι διάδικοι οφείλουν να καταθέσουν τις προτάσεις και να προσκομίσουν όλα τα αποδεικτικά μέσα και τα διαδικαστικά έγγραφα που επικαλούνται με αυτές. Η προθεσμία αυτή δεν αναστέλλεται κατά τη διάρκεια της διαμεσολάβησης. Η προθεσμία παρατείνεται σε εκατόν είκοσι (120) ημέρες αν ο εναγόμενος ή κάποιος από τους ομοδίκους του διαμένει στο εξωτερικό ή είναι άγνωστης διαμονής. Βλ. Αρθ. 237 § 1 ΚΠολΔ, όπως αντικαταστάθηκε με το Ν. 5221/2025 (Α' 133/28-7-2025). Ισχύει για αγωγές που κατατίθενται από 1/1/2026.`,
      ];
    } else {
      text.nomothesia = [
        `Αρθ. 237 § 3 ΚΠολΔ (Ν. 5221/2025). Στην περίπτωση έκδοσης παραπεμπτικής απόφασης ή κατάθεσης κλήσης, οι προθεσμίες των ενενήντα (90) ή εκατόν είκοσι (120) ημερών αρχίζουν από την κατάθεση της κλήσης για τον προσδιορισμό δικασίμου. Η προθεσμία δεν αναστέλλεται κατά τη διαμεσολάβηση. Βλ. Αρθ. 237 § 3 ΚΠολΔ, όπως αντικαταστάθηκε με το Ν. 5221/2025 (Α' 133/28-7-2025). Ισχύει για αγωγές που κατατίθενται από 1/1/2026.`,
      ];
    }
  } else if (new Date(start).getTime() >= new Date('2022-01-01').getTime()) {
    if (options.klisi === false) {
      text.nomothesia = [
