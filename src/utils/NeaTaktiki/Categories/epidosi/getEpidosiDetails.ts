...
export const getEpidosiDetails = (
  ...
  if (new Date(start).getTime() >= new Date('2026-01-01').getTime()) {
    text.nomothesia = [
      `Αρθ. 215 ΚΠολΔ (Ν. 5221/2025). Στην περίπτωση του άρθρου 237, η αγωγή επιδίδεται στον εναγόμενο μέσα σε προθεσμία τριάντα (30) ημερών από την κατάθεσή της. Αν η αγωγή πρέπει να επιδοθεί στο εξωτερικό, πρέπει να επιδοθεί και στον εισαγγελέα κατά το άρθρο 134 § 1 μέσα στην ίδια προθεσμία. Αν η αγωγή δεν επιδοθεί νομίμως μέσα στην προθεσμία αυτή, θεωρείται ως μη ασκηθείσα. Για τη δικάσιμο, το άρθρο 215 § 1 ορίζει προθεσμία που δεν μπορεί να υπερβαίνει τις διακόσιες δέκα (210) ημέρες από την κατάθεση, ενώ για επίδοση στο εξωτερικό προβλέπει προσδιορισμό μετά την πάροδο εννέα (9) μηνών και όχι πέραν του δέκατου μήνα.`,
    ];
  } else {
    text.nomothesia = [
