...
export const getDikasimosDetails = (
  ...
  return {
    nomothesia: [
      `Αρθ. 215 § 1 ΚΠολΔ (Ν. 5221/2025). Με την κατάθεση της αγωγής ορίζεται δικάσιμος, η οποία προσδιορίζεται σε διάστημα που δεν μπορεί να υπερβαίνει τις διακόσιες δέκα (210) ημέρες από την κατάθεση.`,
    ],
    ypologismos: [
      `Στον υπολογισμό εξαιρέθηκε το διάστημα από 1 Ιουλίου έως 15 Σεπτεμβρίου (δικαστικές διακοπές).`,
      `Μέγιστη ημερομηνία δικασίμου: ${
        dikasimosWindow.dikasimosLatest ?? '—'
      }.`,
    ],
    imeres: [`Έως 210 ημέρες από την κατάθεση (με εξαίρεση 1/7-15/9).`],
  };
};
